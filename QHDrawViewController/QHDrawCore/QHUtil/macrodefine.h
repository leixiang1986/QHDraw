...
#define QHIS_IPAD                (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad)


#define QHAPPVERSION [[NSBundle mainBundle] objectForInfoDictionaryKey:@"CFBundleShortVersionString"]
